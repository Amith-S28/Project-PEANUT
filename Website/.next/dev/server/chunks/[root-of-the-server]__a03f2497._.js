...
async function GET() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        stats: {
            trees_certified: plantings.filter((p)=>p.status === 'approved').length,
            verified_submissions: plantings.filter((p)=>p.status === 'approved').length,
            districts_focused: Array.from(new Set(plantings.map((p)=>p.district))),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a03f2497._.js.map