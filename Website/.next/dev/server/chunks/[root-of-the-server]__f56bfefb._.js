...
"[project]/Website/app/api/states/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$lib$2f$csv$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRawDistrictsData"])();
        const statesSet = new Set(data.map((d)=>d.state).filter(Boolean));
        return __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(Array.from(statesSet).sort());
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f56bfefb._.js.map