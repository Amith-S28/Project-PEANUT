...
"[project]/Website/app/api/admin/approve-request/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        const admin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$lib$2f$csv$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])();
        if (!admin || !admin.isAdmin) return __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Unauthorized Admin"
        }, {
            status: 401
        });
        const { id, credits } = await request.json();
        const requests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$lib$2f$csv$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readRequests"])();
        const reqIndex = requests.findIndex((r)=>r.id === id);
        if (reqIndex === -1) return __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const userIndex = users.findIndex((u)=>u.id === requests[reqIndex].user_id);
        if (userIndex !== -1) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Website$2f$lib$2f$csv$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeRequests"])(requests);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e65a9339._.js.map